...
## 1 CXCL6   sh_EWS_vs_Ctr…    130.           -1.65 0.318 -7.02 2.27e-12 5.54e-11 0.107 ENSG00000…
## 2 C3      sh_EWS_vs_Ctr…     49.3          -1.23 0.428 -4.78 1.76e- 6 1.67e- 5 0.138 ENSG00000…
...
##  2 PTGS2   Hrs_6_vs_0_…   1907.            1.42 2.68  20.2  1.35e-90 1.35e-88 0.0576 ENSG00000…
##  3 IL6     Hrs_6_vs_0_…    914.            1.73 3.32  20.0  8.93e-89 5.95e-87 0.0724 ENSG00000…
##  4 CXCL8   Hrs_6_vs_0_…   1409.            3.04 8.24  19.8  4.19e-87 2.09e-85 0.122  ENSG00000…
##  5 TNFAIP3 Hrs_6_vs_0_…    780.            1.67 3.18  17.9  6.41e-72 2.56e-70 0.0741 ENSG00000…
##  6 CXCL1   Hrs_6_vs_0_…   1533.            2.23 4.69  16.4  1.46e-60 4.86e-59 0.101  ENSG00000…
##  7 RELB    Hrs_6_vs_0_…    436.            1.83 3.55  16.0  9.66e-58 2.76e-56 0.0874 ENSG00000…
##  8 IL11    Hrs_6_vs_0_…    659.            1.26 2.40  13.0  1.21e-38 3.03e-37 0.0823 ENSG00000…
##  9 FOS     Hrs_6_vs_0_…    263.           -1.25 0.421 -9.69 3.48e-22 5.80e-21 0.112  ENSG00000…
## 10 CXCL6   Hrs_6_vs_0_…    130.            1.63 3.10   9.60 7.94e-22 1.22e-20 0.141  ENSG00000…
## 11 CXCL3   Hrs_6_vs_0_…    132.            1.52 2.87   8.68 3.89e-18 5.55e-17 0.146  ENSG00000…
## 12 CCL7    Hrs_6_vs_0_…     63.2           1.80 3.48   6.96 3.47e-12 3.66e-11 0.182  ENSG00000…
## 13 CXCR4   Hrs_6_vs_0_…     88.0           1.27 2.41   6.28 3.37e-10 2.93e- 9 0.161  ENSG00000…
## 14 CXCL5   Hrs_6_vs_0_…     47.5           1.61 3.06   5.52 3.48e- 8 2.40e- 7 0.207  ENSG00000…
## 15 CSF2    Hrs_6_vs_0_…     38.4           2.15 4.43   4.99 6.13e- 7 4.09e- 6 0.232  ENSG00000…
## 16 MAP2K6  Hrs_6_vs_0_…     61.2          -1.05 0.485 -3.39 6.88e- 4 3.13e- 3 0.189  ENSG00000…
## # ℹ 1 more variable: significant <chr>
## 
## $shEWS.Hrs2
## # A tibble: 0 × 11
## # ℹ 11 variables: Feature <chr>, contrast_dir <chr>, baseMean <dbl>, log2FoldChange <dbl>,
## #   FC <dbl>, stat <dbl>, pvalue <dbl>, padj <dbl>, lfcSE <dbl>, ensembl_id <chr>,
## #   significant <chr>
## 
## $shEWS.Hrs6
## # A tibble: 0 × 11
...
##   Feature contrast_dir baseMean log2FoldChange    FC   stat   pvalue     padj  lfcSE ensembl_id
##   <chr>   <chr>           <dbl>          <dbl> <dbl>  <dbl>    <dbl>    <dbl>  <dbl> <chr>     
## 1 CCL2    sh_EWS_vs_C…   3119.          -0.945 0.519 -14.8  1.61e-49 1.37e-47 0.0474 ENSG00000…
## 2 IL6     sh_EWS_vs_C…    914.          -0.462 0.726  -2.41 1.59e- 2 5.83e- 2 0.0596 ENSG00000…
## 3 CSF2    sh_EWS_vs_C…     38.4          0.784 1.72    1.65 9.95e- 2 2.37e- 1 0.147  ENSG00000…
## # ℹ 1 more variable: significant <chr>
## 
## $Hrs_2_vs_0
## # A tibble: 3 × 11
...
##   Feature contrast_dir  baseMean log2FoldChange    FC  stat   pvalue     padj  lfcSE ensembl_id
##   <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>    <dbl>    <dbl>  <dbl> <chr>     
## 1 CCL2    Hrs_6_vs_0_up   3119.            1.25  2.38 20.8  3.57e-96 7.14e-94 0.0507 ENSG00000…
## 2 IL6     Hrs_6_vs_0_up    914.            1.73  3.32 20.0  8.93e-89 5.95e-87 0.0724 ENSG00000…
## 3 CSF2    Hrs_6_vs_0_up     38.4           2.15  4.43  4.99 6.13e- 7 4.09e- 6 0.232  ENSG00000…
## # ℹ 1 more variable: significant <chr>
## 
## $shEWS.Hrs2
## # A tibble: 3 × 11
##   Feature contrast_dir    baseMean log2FoldChange    FC   stat  pvalue   padj  lfcSE ensembl_id
##   <chr>   <chr>              <dbl>          <dbl> <dbl>  <dbl>   <dbl>  <dbl>  <dbl> <chr>     
## 1 IL6     shEWS.Hrs2_down    914.          -0.204 0.868 -3.57  3.61e-4 0.0330 0.0672 ENSG00000…
## 2 CCL2    shEWS.Hrs2_down   3119.          -0.107 0.929 -1.19  2.33e-1 0.983  0.0616 ENSG00000…
...
##   Feature contrast_dir    baseMean log2FoldChange    FC   stat pvalue  padj  lfcSE ensembl_id  
##   <chr>   <chr>              <dbl>          <dbl> <dbl>  <dbl>  <dbl> <dbl>  <dbl> <chr>       
## 1 IL6     shEWS.Hrs6_down    914.         -0.0935 0.937 -2.48  0.0131 0.658 0.0584 ENSG0000013…
## 2 CCL2    shEWS.Hrs6_up     3119.          0.0489 1.03   0.881 0.378  0.997 0.0561 ENSG0000010…
## 3 CSF2    shEWS.Hrs6_up       38.4         0.123  1.09   0.672 0.501  0.997 0.0317 ENSG0000016…
## # ℹ 1 more variable: significant <chr>
```
...
## $sh_EWS_vs_Ctrl
##       MMP3        C1S       CCL2        C1R 
##   8.804869 -11.694360 -14.793754 -15.121750
```
...
##   Feature contrast_dir  baseMean log2FoldChange    FC  stat   pvalue     padj  lfcSE ensembl_id
##   <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>    <dbl>    <dbl>  <dbl> <chr>     
## 1 C1R     sh_EWS_vs_Ct…    5967.         -0.799 0.575 -15.1 1.16e-51 1.99e-49 0.0427 ENSG00000…
## 2 C1R     sh_EWS_vs_Ct…    5967.         -0.799 0.575 -15.1 1.16e-51 1.99e-49 0.0427 ENSG00000…
## 3 CCL2    sh_EWS_vs_Ct…    3119.         -0.945 0.519 -14.8 1.61e-49 1.37e-47 0.0474 ENSG00000…
## # ℹ 1 more variable: significant <chr>
```
