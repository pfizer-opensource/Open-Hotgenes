...
##  1 C1R     sh_EWS_vs_Ctrl_…    5967.         -0.819 0.567 -48.7  1.16e-51 1.99e-49 0.0547
##  2 C1R     sh_EWS_vs_Ctrl_…    5967.         -0.819 0.567 -48.7  1.16e-51 1.99e-49 0.0547
##  3 CCL2    sh_EWS_vs_Ctrl_…    3119.         -0.959 0.514 -46.9  1.61e-49 1.37e-47 0.0657
##  4 C1S     sh_EWS_vs_Ctrl_…    3514.         -0.602 0.659 -29.1  1.36e-31 7.76e-30 0.0525
##  5 MMP3    sh_EWS_vs_Ctrl_…    3986.          0.597 1.51   16.3  1.31e-18 5.60e-17 0.0698
##  6 HMGB2   sh_EWS_vs_Ctrl_…    1118.          0.606 1.52   13.1  2.29e-15 7.83e-14 0.0794
##  7 STAT1   sh_EWS_vs_Ctrl_…    4448.         -0.349 0.785 -10.9  4.52e-13 1.29e-11 0.0493
##  8 CXCL6   sh_EWS_vs_Ctrl_…     130.         -1.77  0.294 -10.3  2.27e-12 5.54e-11 0.267 
##  9 IL1R1   sh_EWS_vs_Ctrl_…    1519.         -0.457 0.728  -9.21 2.88e-11 6.16e-10 0.0720
## 10 RAC1    sh_EWS_vs_Ctrl_…    9136.          0.267 1.20    8.47 1.80e-10 3.43e- 9 0.0427
...
##    Feature contrast_dir  baseMean log2FoldChange    FC  stat    pvalue      padj  lfcSE
##    <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>     <dbl>     <dbl>  <dbl>
##  1 IL6     Hrs_2_vs_0_up     914.          2.49   5.60 154.  7.56e-157 1.93e-154 0.0936
##  2 TNFAIP3 Hrs_2_vs_0_up     780.          2.12   4.33  98.1 5.75e-101 7.34e- 99 0.0997
##  3 CXCL8   Hrs_2_vs_0_up    1409.          3.49  11.2   81.1 8.35e- 84 7.10e- 82 0.181 
##  4 IL11    Hrs_2_vs_0_up     659.          2.00   3.99  71.9 1.93e- 74 1.23e- 72 0.110 
##  5 PTGS2   Hrs_2_vs_0_up    1907.          1.12   2.18  51.8 3.41e- 54 1.74e- 52 0.0730
##  6 SMAD7   Hrs_2_vs_0_up    3674.          0.933  1.91  48.1 1.98e- 50 8.40e- 49 0.0629
##  7 CXCL1   Hrs_2_vs_0_up    1533.          2.08   4.24  46.4 1.08e- 48 3.92e- 47 0.144 
##  8 CCL2    Hrs_2_vs_0_up    3119.          0.812  1.76  39.3 1.63e- 41 5.19e- 40 0.0607
##  9 JUN     Hrs_2_vs_0_up    1619.          0.767  1.70  19.0 3.84e- 21 1.09e- 19 0.0823
## 10 CXCL3   Hrs_2_vs_0_up     132.          2.00   3.99  14.5 1.37e- 16 3.50e- 15 0.250 
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $Hrs_6_vs_0
## # A tibble: 10 × 11
##    Feature contrast_dir  baseMean log2FoldChange    FC  stat   pvalue     padj  lfcSE
##    <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>    <dbl>    <dbl>  <dbl>
##  1 CCL2    Hrs_6_vs_0_up    3119.          1.24   2.36  93.1 3.57e-96 7.14e-94 0.0600
##  2 PTGS2   Hrs_6_vs_0_up    1907.          1.44   2.72  87.9 1.35e-90 1.35e-88 0.0720
##  3 IL6     Hrs_6_vs_0_up     914.          1.89   3.70  86.2 8.93e-89 5.95e-87 0.0952
##  4 CXCL8   Hrs_6_vs_0_up    1409.          3.55  11.7   84.7 4.19e-87 2.09e-85 0.181 
##  5 TNFAIP3 Hrs_6_vs_0_up     780.          1.79   3.47  69.6 6.41e-72 2.56e-70 0.101 
##  6 CXCL1   Hrs_6_vs_0_up    1533.          2.33   5.03  58.3 1.46e-60 4.86e-59 0.143 
##  7 RELB    Hrs_6_vs_0_up     436.          1.90   3.72  55.6 9.66e-58 2.76e-56 0.120 
##  8 IL11    Hrs_6_vs_0_up     659.          1.44   2.71  36.5 1.21e-38 3.03e-37 0.112 
##  9 BIRC2   Hrs_6_vs_0_up    5074.          0.727  1.66  31.5 1.42e-33 3.15e-32 0.0610
## 10 NFKB1   Hrs_6_vs_0_up     705.          0.985  1.98  24.1 3.94e-26 7.88e-25 0.0949
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $shEWS.Hrs2
## # A tibble: 5 × 11
##   Feature contrast_dir    baseMean log2FoldChange    FC  stat    pvalue   padj   lfcSE
##   <chr>   <chr>              <dbl>          <dbl> <dbl> <dbl>     <dbl>  <dbl>   <dbl>
## 1 TNFAIP3 shEWS.Hrs2_down     780.      -0.495    0.710 -1.93 0.0000462 0.0118 0.153  
## 2 IL6     shEWS.Hrs2_down     914.      -0.400    0.758 -1.48 0.000361  0.0330 0.156  
## 3 TGFBR1  shEWS.Hrs2_down    3125.      -0.214    0.862 -1.48 0.000388  0.0330 0.0866 
## 4 CXCL3   shEWS.Hrs2_down     132.      -0.773    0.585 -1.03 0.00146   0.0932 0.416  
## 5 CXCL8   shEWS.Hrs2_down    1409.      -0.000781 0.999 -1.01 0.00192   0.0980 0.00815
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $shEWS.Hrs6
## # A tibble: 1 × 11
##   Feature contrast_dir  baseMean log2FoldChange    FC  stat   pvalue   padj lfcSE
##   <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>    <dbl>  <dbl> <dbl>
## 1 FOS     shEWS.Hrs6_up     263.          0.656  1.58  1.04 0.000359 0.0916 0.262
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
```
...
##   Feature contrast_dir       baseMean log2FoldChange    FC   stat   pvalue     padj lfcSE
##   <chr>   <chr>                 <dbl>          <dbl> <dbl>  <dbl>    <dbl>    <dbl> <dbl>
## 1 CXCL6   sh_EWS_vs_Ctrl_do…    130.           -1.77 0.294 -10.3  2.27e-12 5.54e-11 0.267
## 2 C3      sh_EWS_vs_Ctrl_do…     49.3          -1.62 0.325  -4.78 1.76e- 6 1.67e- 5 0.391
## 3 MAP3K9  sh_EWS_vs_Ctrl_up      26.8           1.59 3.02    3.06 1.18e- 4 8.78e- 4 0.528
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
```
...
##   Feature contrast_dir     baseMean log2FoldChange    FC    stat   pvalue     padj  lfcSE
##   <chr>   <chr>               <dbl>          <dbl> <dbl>   <dbl>    <dbl>    <dbl>  <dbl>
## 1 CCL2    sh_EWS_vs_Ctrl_…   3119.          -0.959 0.514 -46.9   1.61e-49 1.37e-47 0.0657
## 2 IL6     sh_EWS_vs_Ctrl_…    914.          -0.218 0.860  -1.23  1.59e- 2 5.83e- 2 0.108 
## 3 CSF2    sh_EWS_vs_Ctrl_…     38.4          0.100 1.07    0.624 9.95e- 2 2.37e- 1 0.216 
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $Hrs_2_vs_0
## # A tibble: 3 × 11
...
##   <chr>   <chr>            <dbl>          <dbl> <dbl>  <dbl>     <dbl>     <dbl>  <dbl>
## 1 IL6     Hrs_2_vs_0_up    914.           2.49   5.60 154.   7.56e-157 1.93e-154 0.0936
## 2 CCL2    Hrs_2_vs_0_up   3119.           0.812  1.76  39.3  1.63e- 41 5.19e- 40 0.0607
## 3 CSF2    Hrs_2_vs_0_up     38.4          1.30   2.46   1.57 3.31e-  3 2.72e-  2 0.661 
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $Hrs_6_vs_0
## # A tibble: 3 × 11
...
##   <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>    <dbl>    <dbl>  <dbl>
## 1 CCL2    Hrs_6_vs_0_up   3119.            1.24  2.36 93.1  3.57e-96 7.14e-94 0.0600
## 2 IL6     Hrs_6_vs_0_up    914.            1.89  3.70 86.2  8.93e-89 5.95e-87 0.0952
## 3 CSF2    Hrs_6_vs_0_up     38.4           2.60  6.05  5.39 6.13e- 7 4.09e- 6 0.572 
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $shEWS.Hrs2
## # A tibble: 3 × 11
##   Feature contrast_dir    baseMean log2FoldChange    FC     stat   pvalue   padj   lfcSE
##   <chr>   <chr>              <dbl>          <dbl> <dbl>    <dbl>    <dbl>  <dbl>   <dbl>
## 1 IL6     shEWS.Hrs2_down    914.      -0.400     0.758 -1.48    0.000361 0.0330 0.156  
## 2 CCL2    shEWS.Hrs2_down   3119.      -0.000981  0.999 -0.00746 0.233    0.983  0.00815
## 3 CSF2    shEWS.Hrs2_up       38.4      0.0000373 1.00   0.00746 0.662    0.983  0.00810
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $shEWS.Hrs6
## # A tibble: 3 × 11
##   Feature contrast_dir    baseMean log2FoldChange    FC     stat pvalue  padj   lfcSE
##   <chr>   <chr>              <dbl>          <dbl> <dbl>    <dbl>  <dbl> <dbl>   <dbl>
## 1 IL6     shEWS.Hrs6_down    914.    -0.0000187   1.000 -0.182   0.0131 0.658 0.00144
## 2 CCL2    shEWS.Hrs6_down   3119.    -0.00000324  1.000 -0.00120 0.378  0.997 0.00144
## 3 CSF2    shEWS.Hrs6_up       38.4    0.000000956 1.00   0.00120 0.501  0.997 0.00144
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
```
...
## CCL2                    -0.9588353         -46.8619299                 0.8115152
## IL6                     -0.2175810          -1.2341166                 2.4864430
## CSF2                     0.1000838           0.6243459                 1.3006816
##      Hrs_2_vs_0_stat Hrs_6_vs_0_log2FoldChange Hrs_6_vs_0_stat shEWS.Hrs2_log2FoldChange
## CCL2       39.284892                  1.240551       93.146191             -9.812312e-04
## IL6       153.714945                  1.887527       86.225454             -3.995497e-01
## CSF2        1.565419                  2.597729        5.388582              3.725334e-05
##      shEWS.Hrs2_stat shEWS.Hrs6_log2FoldChange shEWS.Hrs6_stat
## CCL2    -0.007460348             -3.236547e-06    -0.001199919
## IL6     -1.481969498             -1.868006e-05    -0.181614602
## CSF2     0.007460348              9.562535e-07     0.001199919
```
