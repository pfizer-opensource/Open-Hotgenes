...
## 1 CXCL6   sh_EWS_vs_Ctrl_down    130.           -1.65 0.318 -7.02 2.27e-12 5.54e-11 0.107
## 2 C3      sh_EWS_vs_Ctrl_down     49.3          -1.23 0.428 -4.78 1.76e- 6 1.67e- 5 0.138
...
##   Feature contrast_dir  baseMean log2FoldChange    FC  stat    pvalue      padj  lfcSE
##   <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>     <dbl>     <dbl>  <dbl>
## 1 IL6     Hrs_2_vs_0_up     914.           2.30  4.94 26.7  7.56e-157 1.93e-154 0.0725
## 2 TNFAIP3 Hrs_2_vs_0_up     780.           1.92  3.79 21.3  5.75e-101 7.34e- 99 0.0750
## 3 CXCL8   Hrs_2_vs_0_up    1409.           2.88  7.35 19.4  8.35e- 84 7.10e- 82 0.120 
## 4 IL11    Hrs_2_vs_0_up     659.           1.80  3.49 18.3  1.93e- 74 1.23e- 72 0.0821
## 5 PTGS2   Hrs_2_vs_0_up    1907.           1.12  2.17 15.5  3.41e- 54 1.74e- 52 0.0595
## 6 CXCL1   Hrs_2_vs_0_up    1533.           1.87  3.67 14.7  1.08e- 48 3.92e- 47 0.101 
## 7 CXCL3   Hrs_2_vs_0_up     132.           1.30  2.47  8.27 1.37e- 16 3.50e- 15 0.143 
## 8 CXCL2   Hrs_2_vs_0_up     128.           1.23  2.34  7.40 1.34e- 13 3.11e- 12 0.141 
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $Hrs_6_vs_0
## # A tibble: 16 × 11
...
##  2 PTGS2   Hrs_6_vs_0_up     1907.            1.42 2.68  20.2  1.35e-90 1.35e-88 0.0576
##  3 IL6     Hrs_6_vs_0_up      914.            1.73 3.32  20.0  8.93e-89 5.95e-87 0.0724
##  4 CXCL8   Hrs_6_vs_0_up     1409.            3.04 8.24  19.8  4.19e-87 2.09e-85 0.122 
##  5 TNFAIP3 Hrs_6_vs_0_up      780.            1.67 3.18  17.9  6.41e-72 2.56e-70 0.0741
##  6 CXCL1   Hrs_6_vs_0_up     1533.            2.23 4.69  16.4  1.46e-60 4.86e-59 0.101 
##  7 RELB    Hrs_6_vs_0_up      436.            1.83 3.55  16.0  9.66e-58 2.76e-56 0.0874
##  8 IL11    Hrs_6_vs_0_up      659.            1.26 2.40  13.0  1.21e-38 3.03e-37 0.0823
##  9 FOS     Hrs_6_vs_0_down    263.           -1.25 0.421 -9.69 3.48e-22 5.80e-21 0.112 
## 10 CXCL6   Hrs_6_vs_0_up      130.            1.63 3.10   9.60 7.94e-22 1.22e-20 0.141 
## 11 CXCL3   Hrs_6_vs_0_up      132.            1.52 2.87   8.68 3.89e-18 5.55e-17 0.146 
## 12 CCL7    Hrs_6_vs_0_up       63.2           1.80 3.48   6.96 3.47e-12 3.66e-11 0.182 
## 13 CXCR4   Hrs_6_vs_0_up       88.0           1.27 2.41   6.28 3.37e-10 2.93e- 9 0.161 
## 14 CXCL5   Hrs_6_vs_0_up       47.5           1.61 3.06   5.52 3.48e- 8 2.40e- 7 0.207 
## 15 CSF2    Hrs_6_vs_0_up       38.4           2.15 4.43   4.99 6.13e- 7 4.09e- 6 0.232 
## 16 MAP2K6  Hrs_6_vs_0_down     61.2          -1.05 0.485 -3.39 6.88e- 4 3.13e- 3 0.189 
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $shEWS.Hrs2
## # A tibble: 0 × 11
## # ℹ 11 variables: Feature <chr>, contrast_dir <chr>, baseMean <dbl>,
## #   log2FoldChange <dbl>, FC <dbl>, stat <dbl>, pvalue <dbl>, padj <dbl>, lfcSE <dbl>,
## #   ensembl_id <chr>, significant <chr>
## 
## $shEWS.Hrs6
## # A tibble: 0 × 11
## # ℹ 11 variables: Feature <chr>, contrast_dir <chr>, baseMean <dbl>,
...
##   Feature contrast_dir      baseMean log2FoldChange    FC   stat   pvalue     padj  lfcSE
##   <chr>   <chr>                <dbl>          <dbl> <dbl>  <dbl>    <dbl>    <dbl>  <dbl>
## 1 CCL2    sh_EWS_vs_Ctrl_d…   3119.          -0.945 0.519 -14.8  1.61e-49 1.37e-47 0.0474
## 2 IL6     sh_EWS_vs_Ctrl_d…    914.          -0.462 0.726  -2.41 1.59e- 2 5.83e- 2 0.0596
## 3 CSF2    sh_EWS_vs_Ctrl_up     38.4          0.784 1.72    1.65 9.95e- 2 2.37e- 1 0.147 
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $Hrs_2_vs_0
## # A tibble: 3 × 11
...
##   <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>     <dbl>     <dbl>  <dbl>
## 1 IL6     Hrs_2_vs_0_up    914.           2.30   4.94 26.7  7.56e-157 1.93e-154 0.0725
## 2 CCL2    Hrs_2_vs_0_up   3119.           0.808  1.75 13.5  1.63e- 41 5.19e- 40 0.0522
## 3 CSF2    Hrs_2_vs_0_up     38.4          0.966  1.95  2.94 3.31e-  3 2.72e-  2 0.210 
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $Hrs_6_vs_0
## # A tibble: 3 × 11
...
##   Feature contrast_dir    baseMean log2FoldChange    FC   stat   pvalue   padj  lfcSE
##   <chr>   <chr>              <dbl>          <dbl> <dbl>  <dbl>    <dbl>  <dbl>  <dbl>
## 1 IL6     shEWS.Hrs2_down    914.          -0.204 0.868 -3.57  0.000361 0.0330 0.0672
## 2 CCL2    shEWS.Hrs2_down   3119.          -0.107 0.929 -1.19  0.233    0.983  0.0616
## 3 CSF2    shEWS.Hrs2_up       38.4          0.121 1.09   0.437 0.662    0.983  0.0421
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
## 
## $shEWS.Hrs6
## # A tibble: 3 × 11
...
DE(htgs,
   ...
   padj_cut = 0.1) |> head()
## $sh_EWS_vs_Ctrl
##  [1] "C1R"      "CCL2"     "C1S"      "MMP3"     "HMGB2"    "STAT1"    "CXCL6"   
##  [8] "IL1R1"    "RAC1"     "HMGB1"    "MEF2D"    "JUN"      "GNB1"     "HIF1A"   
## [15] "PTGS1"    "TUBB"     "BCL2L1"   "C3"       "HMGN1"    "ROCK2"    "BIRC2"   
## [22] "CLTC"     "MAP3K9"   "CEBPB"    "CSF1"     "CXCL3"    "MEF2A"    "MASP1"   
## [29] "MAPKAPK2" "PTGER3"   "SMAD7"    "HPRT1"    "RHOA"     "GNAQ"     "TCF4"    
## [36] "TRAF2"    "MX2"      "HRAS"     "RAF1"     "CXCL2"    "RIPK2"    "SHC1"    
## [43] "MAPK1"    "CD40"     "FLT1"     "IL6"      "NR3C1"    "LY96"     "CCL7"    
## [50] "CFD"      "NFKB1"    "MAPK14"
```
...
DE(htgs,
   ...
   padj_cut  = 1) |> head()
## $sh_EWS_vs_Ctrl
##          MMP3         HMGB2          RAC1         HMGB1         MEF2D           JUN 
##   8.804868849   7.924607722   6.377266648   6.256206649   6.249395109   5.840344544 
##          GNB1         PTGS1          TUBB        BCL2L1         HMGN1         ROCK2 
##   5.749781072   5.421186672   4.987660002   4.923589326   4.545913648   4.533313571 
##         BIRC2          CLTC        MAP3K9         CXCL3         MEF2A        PTGER3 
##   4.372898503   4.033724594   3.850076949   3.582782303   3.571696499   3.200366989 
##      MAPKAPK2         HPRT1         SMAD7          RHOA          GNAQ          TCF4 
##   3.189255010   3.187594235   3.182802516   3.121686791   3.072143484   3.047615199 
##         TRAF2          HRAS          RAF1         CXCL2         RIPK2          SHC1 
##   2.773197690   2.686051482   2.669045161   2.629158783   2.588689220   2.581941646 
##         MAPK1          CD40         NR3C1          FLT1        MAPK14         PRKCA 
##   2.495721897   2.432595037   2.420764606   2.408188384   2.167608036   2.125741450 
##        LTB4R2         HSPB2         MAPK8          BCL6        MAP2K1         PTGS2 
##   2.090346433   2.034842705   2.033232169   2.007788679   1.986748183   1.973559554 
##         PLCB1          IL18          CFL1          GNAS        MAP3K5       TNFAIP3 
##   1.966381213   1.873535913   1.776091942   1.762105575   1.691958207   1.671318830 
##          CSF2          RELA         TGFB1         C3AR1         MEF2C         CDC42 
##   1.647500550   1.644807323   1.506099888   1.412369257   1.345720779   1.326425941 
##          AGER          CCR3          NOD1         CREB1         HDAC4       RPS6KA5 
##   1.313589034   1.255322961   1.151482524   1.150424036   1.134380457   1.112521229 
##          PGK1           MYC         CXCR4        MAP3K7        NFATC3         GAPDH 
##   1.107297848   1.054431109   0.975577902   0.944440546   0.932119682   0.869583654 
##        MAP2K6        TOLLIP        TBXA2R         PDGFA          MAFF         LIMK1 
##   0.860028124   0.812850737   0.755614819   0.738878451   0.699018443   0.663112269 
##          PTK2           CD4            C5        PTGER4          IRF5          GUSB 
##   0.608641824   0.596682422   0.550849684   0.542046403   0.450286775   0.369993351 
##          MAFG          ATF2        PTGER2         LTB4R        PTGER1         KEAP1 
##   0.329969739   0.317138296   0.303307640   0.295656729   0.263652465   0.262764676 
##         HSPB1          ELK1          OASL         FXYD2          AREG         IL12A 
##   0.178962936   0.150118893   0.137302381   0.111550319   0.104278358   0.098285814 
##          IL1B         OXER1         TGFB3         TGFB2         CXCL8        MAP2K4 
##   0.091926422   0.084396468   0.065136821   0.012037462   0.006409391  -0.022472649 
##          NOS2          IRF3          DAXX         MYD88        TWIST2        TGFBR1 
##  -0.067861697  -0.168294243  -0.185261760  -0.185671730  -0.198595920  -0.270431958 
##      PPP1R12B          MAFK           FOS        ALOX15         IL12B          GRB2 
##  -0.273608487  -0.274258945  -0.291351601  -0.341430559  -0.345559872  -0.369719241 
##        IL1RAP           C4A         NLRP3         RIPK1          IL15         CXCL5 
##  -0.376122683  -0.382127887  -0.388376547  -0.433518466  -0.443176576  -0.447594655 
##         IFIT3          ARG1         DDIT3          NOX1         PTGFR          IL11 
##  -0.450145072  -0.460057368  -0.501850995  -0.542581776  -0.554283208  -0.572604125 
##        NFE2L2         IFIT1      MAPKAPK5        MAP3K1       PLA2G4A          TLR3 
##  -0.606611605  -0.620080780  -0.625389854  -0.628078514  -0.656366226  -0.728130723 
##         IL17A         TRADD       RAPGEF2         STAT3  BORCS8-MEF2B          TLR4 
##  -0.790217493  -0.800894996  -0.880768554  -0.947527413  -1.030454978  -1.059652572 
##          IL6R       TNFSF14          TLR2          TLR1           IL4          CD55 
##  -1.101442157  -1.128538064  -1.136517693  -1.140050128  -1.207157325  -1.210286467 
##         IFIT2           CFB         PTGIR           MAX         STAT2          IRF7 
##  -1.263788109  -1.317486278  -1.324225420  -1.344429982  -1.365072239  -1.385378120 
##          TLR6        IL10RB         MAPK3           MX1         CXCL1         MKNK1 
##  -1.388137352  -1.412017722  -1.454135184  -1.472299599  -1.638167897  -1.652418849 
##          OAS2          IRF1          RELB         IFI44         NFKB1           CFD 
##  -1.802262738  -1.912021949  -1.925189762  -1.937948286  -2.178631940  -2.214359443 
##          CCL7          LY96           IL6           MX2         MASP1          CSF1 
##  -2.254103775  -2.327393367  -2.410107240  -2.750364692  -3.223947475  -3.756692946 
##         CEBPB            C3         HIF1A         IL1R1         CXCL6         STAT1 
##  -3.764880703  -4.779164610  -5.614461573  -6.652586493  -7.016910026  -7.238916793 
##           C1S          CCL2           C1R 
...
##   Feature contrast_dir       baseMean log2FoldChange    FC  stat   pvalue     padj  lfcSE
##   <chr>   <chr>                 <dbl>          <dbl> <dbl> <dbl>    <dbl>    <dbl>  <dbl>
## 1 C1R     sh_EWS_vs_Ctrl_do…    5967.         -0.799 0.575 -15.1 1.16e-51 1.99e-49 0.0427
## 2 C1R     sh_EWS_vs_Ctrl_do…    5967.         -0.799 0.575 -15.1 1.16e-51 1.99e-49 0.0427
## 3 CCL2    sh_EWS_vs_Ctrl_do…    3119.         -0.945 0.519 -14.8 1.61e-49 1.37e-47 0.0474
## # ℹ 2 more variables: ensembl_id <chr>, significant <chr>
```
...
##      Hrs_2_vs_0_stat Hrs_6_vs_0_log2FoldChange Hrs_6_vs_0_stat shEWS.Hrs2_log2FoldChange
## CCL2       13.497033                  1.251154       20.809222                -0.1065631
## IL6        26.682272                  1.732941       19.975903                -0.2037340
## CSF2        2.937682                  2.146082        4.987054                 0.1212042
##      shEWS.Hrs2_stat shEWS.Hrs6_log2FoldChange shEWS.Hrs6_stat
## CCL2      -1.1934152                0.04893024       0.8812305
## IL6       -3.5671775               -0.09350500      -2.4798332
## CSF2       0.4370389                0.12280155       0.6723109
```
