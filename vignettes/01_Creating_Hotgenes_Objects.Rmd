...
expression data and sample metadata. This example uses a
Drug-Induced Liver Injury (DILI) proteomics dataset to demonstrate
end-to-end object construction with limma.
