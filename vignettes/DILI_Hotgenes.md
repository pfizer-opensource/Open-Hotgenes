...
##   <chr>     <chr>     <chr>                     <chr>                                    
## 1 IGLV4.69  IGLV4-69  sp|A0A075B6H9|LV469_HUMAN Immunoglobulin lambda variable 4-69 OS=H…
## 2 IGLV4.60  IGLV4-60  sp|A0A075B6I1|LV460_HUMAN Immunoglobulin lambda variable 4-60 OS=H…
## 3 IGLV3.16  IGLV3-16  sp|A0A075B6K0|LV316_HUMAN Immunoglobulin lambda variable 3-16 OS=H…
## 4 IGLV3.10  IGLV3-10  sp|A0A075B6K4|LV310_HUMAN Immunoglobulin lambda variable 3-10 OS=H…
## 5 IGLV3.9   IGLV3-9   sp|A0A075B6K5|LV39_HUMAN  Immunoglobulin lambda variable 3-9 OS=Ho…
## 6 IGKV2D.30 IGKV2D-30 sp|A0A075B6S6|KVD30_HUMAN Immunoglobulin kappa variable 2D-30 OS=H…
```
...
## Warning in rlm.default(x = X, y = y, weights = w, ...): 'rlm' failed to converge in 20
## steps
## Warning in rlm.default(x = X, y = y, weights = w, ...): 'rlm' failed to converge in 20
## steps
## Warning in rlm.default(x = X, y = y, weights = w, ...): 'rlm' failed to converge in 20
