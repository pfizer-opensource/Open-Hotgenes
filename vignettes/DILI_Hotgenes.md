...
##   <chr>     <chr>     <chr>                     <chr>                                                   
## 1 IGLV4.69  IGLV4-69  sp|A0A075B6H9|LV469_HUMAN Immunoglobulin lambda variable 4-69 OS=Homo sapiens GN=…
## 2 IGLV4.60  IGLV4-60  sp|A0A075B6I1|LV460_HUMAN Immunoglobulin lambda variable 4-60 OS=Homo sapiens GN=…
## 3 IGLV3.16  IGLV3-16  sp|A0A075B6K0|LV316_HUMAN Immunoglobulin lambda variable 3-16 OS=Homo sapiens GN=…
## 4 IGLV3.10  IGLV3-10  sp|A0A075B6K4|LV310_HUMAN Immunoglobulin lambda variable 3-10 OS=Homo sapiens GN=…
## 5 IGLV3.9   IGLV3-9   sp|A0A075B6K5|LV39_HUMAN  Immunoglobulin lambda variable 3-9 OS=Homo sapiens GN=I…
## 6 IGKV2D.30 IGKV2D-30 sp|A0A075B6S6|KVD30_HUMAN Immunoglobulin kappa variable 2D-30 OS=Homo sapiens GN=…
```
