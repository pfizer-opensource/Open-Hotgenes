...
```
    ...
    ## 1 IL6     Hrs_2_vs_0_…     10.6           2.52  5.72  31.1 4.06e-24 1.04e-21  31.1  45.1 ENSG00000… *          
    ## 2 CXCL8   Hrs_2_vs_0_…     10.9           3.51 11.4   26.0 6.99e-22 8.92e-20  26.0  40.0 ENSG00000… *          
    ## 3 TNFAIP3 Hrs_2_vs_0_…     10.5           2.14  4.42  24.9 2.21e-21 1.88e-19  24.9  38.8 ENSG00000… *          
    ## 
    ## $Hrs_6_vs_0
    ## # A tibble: 3 × 12
    ##   Feature contrast_dir baseMean log2FoldChange    FC  stat   pvalue     padj     t     B ensembl_id significant
    ##   <chr>   <chr>           <dbl>          <dbl> <dbl> <dbl>    <dbl>    <dbl> <dbl> <dbl> <chr>      <chr>      
    ## 1 CXCL8   Hrs_6_vs_0_…     10.9           3.56 11.8   26.4 4.21e-22 1.07e-19  26.4  40.5 ENSG00000… *          
    ## 2 CXCL1   Hrs_6_vs_0_…     11.3           2.35  5.09  24.5 3.71e-21 4.73e-19  24.5  38.2 ENSG00000… *          
    ## 3 CCL2    Hrs_6_vs_0_…     12.5           1.25  2.37  23.0 2.14e-20 1.56e-18  23.0  36.3 ENSG00000… *          
    ## 
    ## $sh_EWS_vs_Ctrl
    ## # A tibble: 3 × 12
    ##   Feature contrast_dir baseMean log2FoldChange    FC  stat   pvalue     padj     t     B ensembl_id significant
    ##   <chr>   <chr>           <dbl>          <dbl> <dbl> <dbl>    <dbl>    <dbl> <dbl> <dbl> <chr>      <chr>      
    ## 1 C1R     sh_EWS_vs_C…     13.5         -0.856 0.553 -16.7 1.33e-16 3.39e-14 -16.7  27.7 ENSG00000… *          
    ## 2 C1R     sh_EWS_vs_C…     13.5         -0.856 0.553 -16.7 1.33e-16 3.39e-14 -16.7  27.7 ENSG00000… *          
    ## 3 CCL2    sh_EWS_vs_C…     12.5         -1.00  0.500 -15.8 5.92e-16 7.55e-14 -15.8  26.4 ENSG00000… *          
    ## 
    ## $shEWS.Hrs2
    ## # A tibble: 3 × 12
    ##   Feature contrast_dir  baseMean log2FoldChange    FC  stat  pvalue   padj     t       B ensembl_id significant
    ##   <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>   <dbl>  <dbl> <dbl>   <dbl> <chr>      <chr>      
    ## 1 TNFAIP3 shEWS.Hrs2_d…    10.5          -0.565 0.676 -4.69 5.84e-5 0.0149 -4.69  1.77   ENSG00000… *          
    ## 2 CXCL3   shEWS.Hrs2_d…     7.90         -1.05  0.482 -3.94 4.57e-4 0.0233 -3.94 -0.0744 ENSG00000… *          
    ...
    ##   Feature contrast_dir  baseMean log2FoldChange    FC  stat    pvalue   padj     t     B ensembl_id significant
    ##   <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>     <dbl>  <dbl> <dbl> <dbl> <chr>      <chr>      
    ## 1 FOS     shEWS.Hrs6_up     8.98          0.826  1.77  4.53 0.0000892 0.0227  4.53  1.12 ENSG00000… *
...
```
    ...
    ## 1 1       Above average… IFIT2     2.91              10.3            9.89           0.100        0.339  0.00362
    ## 2 1       Above average… DDIT3     2.75              10.4           10.1            0.0402       0.231  0.00593
    ## 3 1       Above average… MAP3K1    2.72              10.00           9.75           0.0537       0.216  0.00660
    ## 4 1       Above average… PTGFR     2.65              10.4           10.1            0.0489       0.285  0.00797
    ## 5 1       Above average… PGK1      2.63              15.3           15.2            0.0224       0.0484 0.00851
    ## # ℹ 97 more rows
...
```
    ...
    ## 1 kegg_medicus_reference_ccr_cxcr_gnb_g_pi3k_ra… 6.36e-5 0.00592   0.538 0.924  1.69    10 <chr [2]>          1
