...
```
    ...
    ## To optimize the dose-response modelling, it is recommended to use a dose-response
    ## design with at least six different tested doses.
...
```
    ...
    ## 1 TNFAIP3 shEWS.Hrs2_…    10.5          -0.565 0.676 -4.69 5.84e-5 0.0149 -4.69  1.77   ENSG00000…
    ## 2 CXCL3   shEWS.Hrs2_…     7.90         -1.05  0.482 -3.94 4.57e-4 0.0233 -3.94 -0.0744 ENSG00000…
    ## 3 FOS     shEWS.Hrs2_…     8.98          0.645 1.56   4.14 2.67e-4 0.0233  4.14  0.398  ENSG00000…
    ...
    ##   Feature contrast_dir  baseMean log2FoldChange    FC  stat   pvalue   padj     t     B ensembl_id
    ##   <chr>   <chr>            <dbl>          <dbl> <dbl> <dbl>    <dbl>  <dbl> <dbl> <dbl> <chr>     
    ## 1 FOS     shEWS.Hrs6_up     8.98          0.826  1.77  4.53  8.92e-5 0.0227  4.53  1.12 ENSG00000…
    ## # ℹ 1 more variable: significant <chr>
...
```
    ...
    ## 1 1       Above average in clus… IFIT2     2.91              10.3            9.89           0.100 
    ## 2 1       Above average in clus… DDIT3     2.75              10.4           10.1            0.0402
    ## 3 1       Above average in clus… MAP3K1    2.72              10.00           9.75           0.0537
    ## 4 1       Above average in clus… PTGFR     2.65              10.4           10.1            0.0489
    ## 5 1       Above average in clus… PGK1      2.63              15.3           15.2            0.0224
    ## # ℹ 97 more rows
...
```
    ...
    ## 1 kegg_medicus_reference_ccr_cxcr_… 6.36e-5 0.00592   0.538 0.924  1.69    10 <chr [2]>          1
